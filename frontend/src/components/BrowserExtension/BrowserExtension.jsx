...
const STEPS = [
  {
    ...
    description: 'Browse the web as normal — find something worth keeping.',
  },
  {
    Icon:        Sparkles,
    title:       'Click Save',
    description: 'Hit the MemoryOS extension with one click — that\'s it.',
  },
  {
    Icon:        CheckCircle2,
    title:       'Appears in MemoryOS',
    description: 'AI-summarised, auto-tagged, and ready to search in seconds.',
  },
];
